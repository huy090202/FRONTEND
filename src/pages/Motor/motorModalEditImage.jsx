...
import { updateMotorImage } from '~/services/motorService';

const MotorModalEditImage = ({ isEditImageModalVisible, imageForEdit, onCancel, token }) => {
    ...
    const handleUpdateImage = async () => {
        ...
        try {
            ...
            const response = await updateMotorImage(token, { imageId: imageForEdit.id }, formData);
    ...
    return (
        ...
        >
            <div className='mb-10 text-4xl font-semibold'>Cập nhật ảnh cho xe</div>
            <input
                type='file'
                accept='image/*'
                onChange={(e) => {
...
export default MotorModalEditImage;
